...
namespace WebTest
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("NewProjectPage.aspx");
        }

        protected void NewListButton_Click(object sender, EventArgs e)
        {
            Response.Redirect("NewListPage.aspx");
        }
        ...
        protected void lbtnSubmit_Click(object sender, EventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["WebFormConnectionString"].ToString()))
            {
                ...
                // Set the command text 
                // SQL statement or the name of the stored procedure  
                cmd.CommandText = "INSERT INTO Project (  ProjectName, UserId ) VALUES ( @ProjectName, @UserId )";
        ...
        {
            Response.Redirect("TaskListPage.aspx");
        }
    }
}